                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Update Campaign Info</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
      ...
      form: new Form({
        ...
        methods: {
            ...
            updateCampaign(){
                ...
                // console.log('Editing data');
                //alert(id);
                this.form.put('api/campaigns/'+this.form.camapign_id)
                .then(() => {
                    // success
                    //console.log('$data');
                    //$('#addNew').modal('hide');
        ...
        //     editModal: function(campaign_id) {
        //     this.editmode = false;
        //     axios.get('/api/campaigns/' +campaign_id + '/update').then(({data}) => this.form = new Form(data));
        // },
        //     updateCampaign: function (campaign_id) {
        //     axios.post('/api/campaigns/' + campaign_id, this.campaign)
        //     .then(function (data) {
        // console.log(data)
        //     })
